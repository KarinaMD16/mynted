...
export const es = {
  ...
  'communities.crop.hint': 'Arrastra la imagen para moverla y usa el zoom para acercarla. Lo que queda dentro del marco es lo que se va a ver.',
  ...
  'communities.crop.qualityLow': 'Resolución baja: se va a ver pixelada. Aleja el zoom o usa una imagen más grande',
  ...
  'communities.create.previewHint': 'Así se va a ver tu comunidad una vez creada. Se actualiza mientras llenas el formulario.',
  ...
  'moderation.reports.soon': 'Cocinando la sección de reportes, estate atento a las actualizaciones.',
  'moderation.members.soon': 'Cocinando la sección de miembros, estate atento a las actualizaciones.',
  ...
  'moderation.settings.dangerTitle': 'Zona sensible',
